...
const Cart = () => {
    return (
        <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10  dark:text-black">
	...
	<div className="flex justify-end space-x-4">
		...
		<button type="button" className="px-6 py-2 border rounded-md dark:bg-[#0E77DF] dark:text-white ">
